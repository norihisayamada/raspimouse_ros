...
class MusicActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MusicGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MusicGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MusicActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MusicGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MusicGoal()
    }
...
module.exports = MusicActionGoal;
