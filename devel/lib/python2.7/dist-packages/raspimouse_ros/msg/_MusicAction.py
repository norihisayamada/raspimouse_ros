...
"""autogenerated by genpy from raspimouse_ros/MusicAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import raspimouse_ros.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class MusicAction(genpy.Message):
  _md5sum = "42ff7b7429a7a41f811b2d80963d286f"
  _type = "raspimouse_ros/MusicAction"
...
"""
  ...
  _slot_types = ['raspimouse_ros/MusicActionGoal','raspimouse_ros/MusicActionResult','raspimouse_ros/MusicActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MusicAction, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.freqs)
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.freqs))
      length = len(self.action_goal.goal.durations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.durations))
      _x = self
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_result.result.finished, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_I().pack(self.action_feedback.feedback.remaining_steps))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.freqs = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.durations = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(self.action_goal.goal.freqs.tostring())
      length = len(self.action_goal.goal.durations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.durations.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
